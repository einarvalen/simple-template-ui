...
public class ViewFactory<T> {
	...
	public ViewFactory( Class<T> clazz, Context context, PathSetting pathSetting, DaoParams params) {
		this.clazz = clazz;
		...
		this.columnsForRowModifications = params
				.getColumnsForRowModifications();
